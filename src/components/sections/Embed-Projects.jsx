import Data from "@data/sections/embedded-projects.json";
...
const EmbedProjectsSection = ({ projects }) => {
                  ...
                  {projects.slice(0, Data.numOfItems).map((item, key) => (
                    ...
                    >
                      <div className="onovo-portfolio-item">
                        ...
                        >
                          <a
                            href={`/embedded-projects/${item.id}`}
...
export default EmbedProjectsSection;
